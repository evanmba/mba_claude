...
export const SETTER_MONTHLY_DATA: SetterMonthlyData = {
  "gabriana-brown": {
    "JAN 2026": {
      ...
      goal: 40,
      weeklyBreakdown: [
        { week: "W1", start: "1/5/26", end: "1/11/26", booked: 4, goal: 10 },
        { week: "W2", start: "1/12/26", end: "1/18/26", booked: 3, goal: 10 },
        { week: "W3", start: "1/19/26", end: "1/25/26", booked: 5, goal: 10 },
    ...
    "FEB 2026": {
      ...
      goal: 40,
      weeklyBreakdown: [
        { week: "W5", start: "2/2/26", end: "2/8/26", booked: 5, goal: 10 },
        { week: "W6", start: "2/9/26", end: "2/15/26", booked: 4, goal: 10 },
        { week: "W7", start: "2/16/26", end: "2/22/26", booked: 6, goal: 10 },
        { week: "W8", start: "2/23/26", end: "3/1/26", booked: 3, goal: 10 },
      ],
      dialingDays: [
  ...
  "daneile-brown": {
    "JAN 2026": {
      ...
      goal: 40,
      weeklyBreakdown: [
        { week: "W1", start: "1/5/26", end: "1/11/26", booked: 3, goal: 10 },
        { week: "W2", start: "1/12/26", end: "1/18/26", booked: 4, goal: 10 },
        { week: "W3", start: "1/19/26", end: "1/25/26", booked: 3, goal: 10 },
        { week: "W4", start: "1/26/26", end: "2/1/26", booked: 2, goal: 10 },
      ],
      dialingDays: [
    ...
    "FEB 2026": {
      ...
      goal: 40,
      weeklyBreakdown: [
        { week: "W5", start: "2/2/26", end: "2/8/26", booked: 4, goal: 10 },
        { week: "W6", start: "2/9/26", end: "2/15/26", booked: 5, goal: 10 },
        { week: "W7", start: "2/16/26", end: "2/22/26", booked: 4, goal: 10 },
        { week: "W8", start: "2/23/26", end: "3/1/26", booked: 2, goal: 10 },
      ],
      dialingDays: [
  ...
  "julio-capellan": {
    ...
    "FEB 2026": {
      ...
      weeklyBreakdown: [
        { week: "W5", start: "2/2/26", end: "2/8/26", booked: 5, goal: 10 },
        { week: "W6", start: "2/9/26", end: "2/15/26", booked: 4, goal: 10 },
        { week: "W7", start: "2/16/26", end: "2/22/26", booked: 5, goal: 10 },
        { week: "W8", start: "2/23/26", end: "3/1/26", booked: 3, goal: 10 },
      ],
      dialingDays: [
    ...
    "MAR 2026": {
      ...
      weeklyBreakdown: [
        { week: "W9", start: "3/2/26", end: "3/8/26", booked: 0, goal: 10 },
        { week: "W10", start: "3/9/26", end: "3/14/26", booked: 0, goal: 10 },
        { week: "W11", start: "3/15/26", end: "3/21/26", booked: 2, goal: 10 },
        { week: "W12", start: "3/22/26", end: "3/28/26", booked: 0, goal: 10 },
      ],
      dialingDays: [
  ...
  "allieandra-alexander": {
    "JAN 2026": {
      ...
      goal: 40,
      weeklyBreakdown: [
        { week: "W1", start: "1/5/26", end: "1/11/26", booked: 6, goal: 10 },
        { week: "W2", start: "1/12/26", end: "1/18/26", booked: 6, goal: 10 },
        { week: "W3", start: "1/19/26", end: "1/25/26", booked: 5, goal: 10 },
        { week: "W4", start: "1/26/26", end: "2/1/26", booked: 5, goal: 10 },
      ],
      dialingDays: [
    ...
    "FEB 2026": {
      ...
      goal: 40,
      weeklyBreakdown: [
        { week: "W5", start: "2/2/26", end: "2/8/26", booked: 8, goal: 10 },
        { week: "W6", start: "2/9/26", end: "2/15/26", booked: 7, goal: 10 },
        { week: "W7", start: "2/16/26", end: "2/22/26", booked: 7, goal: 10 },
        { week: "W8", start: "2/23/26", end: "3/1/26", booked: 6, goal: 10 },
      ],
      dialingDays: [
  ...
  "teagan-brown": {
    ...
    "FEB 2026": {
      ...
      goal: 40,
      weeklyBreakdown: [
        { week: "W5", start: "2/2/26", end: "2/8/26", booked: 3, goal: 10 },
        { week: "W6", start: "2/9/26", end: "2/15/26", booked: 3, goal: 10 },
        { week: "W7", start: "2/16/26", end: "2/22/26", booked: 3, goal: 10 },
        { week: "W8", start: "2/23/26", end: "3/1/26", booked: 2, goal: 10 },
      ],
      dialingDays: [
