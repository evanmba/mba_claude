...
const sections = [
  {
    ...
    href: "/instagram",
    icon: Instagram,
    description: "Posts, stories, reels, and engagement metrics for @mendoza.baseball.academy.",
  ...
  },
  {
    ...
    href: "/analytics",
    icon: BarChart3,
    description: "Cross-platform performance metrics, audience insights, and growth trends.",
  ...
  },
  {
    ...
    href: "/news",
    icon: Newspaper,
    description: "Stay up to date with baseball news, trends, and industry updates.",
    bg: "rgba(239, 68, 68, 0.15)",
    color: "#ef4444",
  },
];
